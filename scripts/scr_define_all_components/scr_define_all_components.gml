...
component_array[ComponentEnum.elbow_ccw] = scr_define_component("Elbow", ComponentEnum.elbow_ccw, 300, scr_process_elbow_ccw, scr_draw_elbow_ccw, [IOEnum.output, IOEnum.input, IOEnum.none, IOEnum.none], [4, 4, 0, 0]);
component_array[ComponentEnum.elbow_cw] = scr_define_component("Elbow", ComponentEnum.elbow_cw, 300, scr_process_elbow_cw, scr_draw_elbow_cw, [IOEnum.input, IOEnum.output, IOEnum.none, IOEnum.none], [4, 4, 0, 0]);
